...
local function getSoundForVisualizer()
    if playMode == "CL" then return playingSoundObj end
...
local function createVisualizer()
    ...
    for i = 1, lines do
        ...
        line.Size = Vector3.new(0.22, 1, 0.22)
        line.Anchored = true
    ...
    visualizerConn = RunService.RenderStepped:Connect(function()
        ...
        for i, line in ipairs(visualizerParts) do
            ...
            if tagType == "Owner 👑" then
                line.Color = rainbowColor(t + i*0.2)
            else
...
visualizerBtn.MouseButton1Click:Connect(function()
    ...
    elseif playingSoundObj or playMode == "RL" then createVisualizer() end
end)
...
loggerBtn.Position = UDim2.new(1, -44, 0, 230)
loggerBtn.Text = "🔍"
